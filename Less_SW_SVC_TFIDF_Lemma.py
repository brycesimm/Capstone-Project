...
ngram_vectorizer = TfidfVectorizer(ngram_range=(1, 3), stop_words=stopWords)
...
final_ngram = LinearSVC(C=1, max_iter=900)
final_ngram.fit(X, target)
print ("Final Accuracy: %s" 
    % accuracy_score(target, final_ngram.predict(X_test)))

# Final Accuracy: 0.90012; 0.512% increase over basic implementation
