...
lemTrainingSet = snowballStemClean(regexTrainingSet)
lemTestSet = snowballStemClean(regexTestSet)
...
final_ngram = LinearSVC(C=0.005, max_iter=900)
final_ngram.fit(X, target)
print ("Final Accuracy: %s" 
    % accuracy_score(target, final_ngram.predict(X_test)))

# Final Accuracy: 0.9006;
