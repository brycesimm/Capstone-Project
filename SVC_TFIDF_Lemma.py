...
# c = 0.1 has been found to yield the highest accuracy for this model, about 0.8904

final_ngram = LinearSVC(C=0.1, max_iter=900)
final_ngram.fit(X, target)
print ("Final Accuracy: %s" 
    % accuracy_score(target, final_ngram.predict(X_test)))

# Final Accuracy: 0.88436; 0.512% increase over basic implementation
