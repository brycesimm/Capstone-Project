...
# Should try out different ngram ranges; apparently the size of the matrix grows exponentially when increasing n
...
# c = 0.7 has been found to yield the highest accuracy for this model, about 0.8888
# c = 0.45 has been found to yield the highest accuracy for this model, about 0.88768
...
final_ngram = LogisticRegression(C=0.45, max_iter=500)
final_ngram.fit(X, target)
print ("Final Accuracy: %s" 
    % accuracy_score(target, final_ngram.predict(X_test)))

# Final Accuracy: 0.88764; 0.84% increase over basic implementation
