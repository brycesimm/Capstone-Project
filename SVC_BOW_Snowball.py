...
lemTrainingSet = snowballStemClean(stopTrainingSet)
lemTestSet = snowballStemClean(stopTestSet)
...
# c = 0.25 has been found to yield the highest accuracy for this model, about 0.89008

final_ngram = LinearSVC(C=0.25, max_iter=900)
final_ngram.fit(X, target)
print ("Final Accuracy: %s" 
    % accuracy_score(target, final_ngram.predict(X_test)))

# Final Accuracy: 0.88532; 0.608% increase over basic implementation
